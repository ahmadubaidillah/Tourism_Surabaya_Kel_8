...
<html lang="en">
    <head>
        ...
        <link href="{{asset('css/css/bootstrap-icons.css')}}" rel="stylesheet">

        <link rel="stylesheet" href="{{asset('css/css/magnific-popup.css')}}">

        <link href="{{asset('css/css/aos.css')}}" rel="stylesheet">

        <link href="{{asset('css/css/templatemo-nomad-force.css')}}" rel="stylesheet">
<!--
