          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          <li ><a href="/" >Home</a></li>
                          <li><a href="/maindestinasi" class="active">Destinasi</a></li>
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-12">
              <div class="filters">
                <ul>
                  <li data-filter="*"  class="active">All Destinasi</li>
                  <li data-filter=".Religi">Religi</li>
                  <li data-filter=".Outdoor">Outdoor & Nature</li>
                  <li data-filter=".Pusat">Pusat Perbelanjaan</li>
                  <br>
                  <br>
                  <li data-filter=".Kampung">Kampung Wisata</li>
                  <li data-filter=".Museum">Museum</li>
                  <li data-filter=".Pasar">Pasar Traditional</li>
                  <li data-filter=".Sport">Sport</li>
                  <br>
                  <br>
                  <li data-filter=".History">History & Heritage</li>
                  <li data-filter=".Cagar">Cagar Budaya</li>
                  <li data-filter=".City">City Park</li>
                  <li data-filter=".Monumen">Monumen & Landmark</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-12">
                  ...
                  <div class="col-lg-4 templatemo-item-col all {{$row->kategori}}">
                    <div class="meeting-item">
                      <div class="thumb">
                        ...
                        <a href="/deskripsidestinasi/{{$row->id}}"><img src="{{asset('fotodestinasi/'.$row->foto)}}" alt="" style="height:211.5px;"></a>
                      </div>
